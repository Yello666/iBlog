...
注：因为没有购买多一台同网段的云主机，并且在本地压测云主机会在并发数为30左右时，被阿里云网关给限流，导致请求会报502错误，因此没有很好的分机压测环境，所以在云主机上使用Jmeter进行压测了。压测时CPU最高负载率达到88%，属于高压状态，所以请求时间长。如果使用本地Jmeter压测云主机，50并发的情况下，最高TPS为31左右，约10%的请求会被网关拦截报502错误，CPU空闲率为97%左右。
